...
<head>
    ...
    <link href="/thesis1/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link
        href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
        rel="stylesheet">

    <!-- Custom styles for this template-->
    <link href="/thesis1/css/sb-admin-2.min.css" rel="stylesheet">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row justify-content-end">
                                        <button class="btn btn-primary reg-button" type="submit">Register</button>
                                    </div>
                                <hr>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="text-center">
                                            <a class="small" href="main.php">Already have an account? Login!</a>
                                        </div>
                                    </div>
                                </div>
